...
export default  class Oven extends  CommonDeviceSchema {
    ...
    static async create(name){
        ...
        return new Oven(data.id,data.name,data.meta);
    }

    constructor(id, name, meta){
        super(id,name,meta,DeviceIds.byType.Oven);
    ...
    async setTemperature(value){
        ...
        value = adjustNumberRange(value,Oven.minTemperature(),Oven.maxTemperature());
